...
class MainActivity : AppCompatActivity() {
    ...
    private fun initView() {
        buttonSub.setOnClickListener {
            ...
            val age: String = setAge.text.toString()
                if (name.isEmpty() || secondName.isEmpty()) showToast() else newUser(
                    name,
                    secondName,
                    age
                )
    ...
    private fun newUser(Name: String, secondName: String, Age: String) {
